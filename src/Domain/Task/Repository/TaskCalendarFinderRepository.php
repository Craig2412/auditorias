...
final class TaskCalendarFinderRepository
{
    ...
    public function findTaskCalendar($nro_pag,$cant_registros,$fecha_inicial,$fecha_final): array
    {
        //Paginador
        ...
        ->where(function ($exp, $q) use ($fecha_inicial, $fecha_final) {
            return $exp->between('tasks.estimated_date', $fecha_inicial, $fecha_final);
        }, []);
