...
final class UsuariosBufetesRepository
{
    ...
    {
        return (int)$this->queryFactory->newInsert('usuarios_bufetes', $this->toRow($usuariosbufetes))
            ->execute()
            ->lastInsertId();
    }
    ...
    {
        return [
            'id_usuario' => strtoupper($usuariosbufetes['id_usuario']),
            'id_bufete' => strtoupper($usuariosbufetes['id_bufete'])
        ];
    }
}
